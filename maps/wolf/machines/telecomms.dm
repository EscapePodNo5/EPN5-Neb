...
/obj/machinery/telecomms/hub/preset/wolf
	id = "Hub"
	network = "tcommsat"
...
/obj/machinery/telecomms/bus/preset/wolf
	id = "Main Bus"
	network = "tcommsat"
