...
/obj/item/projectile_equipment/passenger
...
/obj/item/projectile_equipment/passenger/proc/get_passenger()
...
/obj/item/projectile_equipment/passenger/MouseDrop_T(var/mob/target, var/mob/user)
	if(!ismob(target))
		return
...
/obj/item/projectile_equipment/passenger/relaymove(var/mob/user)
...
/obj/item/projectile_equipment/passenger/attackby(var/obj/item/I, var/mob/user)
	if(isCrowbar(I))
		if(hatch_open)
			close_hatch()
		else
...
/obj/item/projectile_equipment/passenger/on_missile_activated(var/obj/effect/overmap/projectile/P)
	P.set_enter_zs(TRUE)
	close_hatch()

/obj/item/projectile_equipment/passenger/on_touch_map_edge(var/obj/effect/overmap/projectile/P)
...
/obj/item/projectile_equipment/passenger/on_trigger()
	eject_passenger()

/obj/item/projectile_equipment/passenger/proc/open_hatch()
...
/obj/item/projectile_equipment/passenger/proc/close_hatch()
	var/mob/passenger = get_passenger()
	if(isnull(passenger))
		return
...
/obj/item/projectile_equipment/passenger/proc/eject_passenger()
	var/mob/passenger = get_passenger()
	if(isnull(passenger))
		return
